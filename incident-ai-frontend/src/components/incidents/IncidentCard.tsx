...
export function IncidentCard({ incident }: IncidentCardProps) {
  ...
  const datafixCode = incident.datafix_code && incident.datafix_code.trim().toLowerCase() !== "null"
    ? incident.datafix_code
    : "";

  const hasDetails = !!(incident.description || incident.resolution_notes || datafixCode);
